...
room VARCHAR  (10),
rent VARCHAR (100),
OwnerNO VARCHAR (10)FOREIGN KEY REFERENCES privateowner (OwnerNO)NULL , 
...
/*
USING  JOIN IN BRANCH AND STAFF TABLE
*/
...
*/
ALTER TABLE Viewing DROP CONSTRAINT FK__viewing__propert__4BAC3F29
 ...
 */
  ...
  SELECT * FROM book1 join class1 on class1.bookid=book1.bookid
